...
void calculate_Stering() {
    ...
    rosidl_runtime_c__float32__Sequence__init(&module1_msg.data, 4);
    module1_msg.data.size = 4;
    rosidl_runtime_c__float32__Sequence__init(&module2_msg.data, 4);
    module2_msg.data.size = 4;
    rosidl_runtime_c__float32__Sequence__init(&module3_msg.data, 4);
    ...
    angle1_correction = Angle_Wheel1_pidf.compute_with_error(WrapDegs(module_front_cmd[0].second - angle_front));
    angle2_correction = Angle_Wheel2_pidf.compute_with_error(WrapDegs(module_rear_left_cmd[0].second - angle_rear_left));
    ...
    angle3_correction = Angle_Wheel2_pidf.compute_with_error(WrapDegs(module_rear_right_cmd[0].second - angle_rear_right));
...
{
    constrain(Motor1Speed, PWM_Min, PWM_Max);
    constrain(Motor2Speed, PWM_Min, PWM_Max);
    constrain(Motor3Speed, PWM_Min, PWM_Max);
    constrain(Motor4Speed, PWM_Min, PWM_Max);
    constrain(Motor5Speed, PWM_Min, PWM_Max);
    constrain(Motor6Speed, PWM_Min, PWM_Max);
